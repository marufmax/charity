           ...
           <div class="layers bd bgc-white p-20">
               ...
               <div class="layer w-100">
                   <div class="peers ai-sb fxw-nw">
                       ...
                       <div class="peer"><span class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-green-50 c-green-500">{{ $totalDonation }} times</span></div>
                   </div>
               </div>
           </div>
       </div>
                       ...
                       <div class="bgc-light-blue-500 c-white p-20">
                           <div class="peers ai-c jc-sb gap-40">
                               <div class="peer peer-greed">
                                   <h5>{{ date('M') }} {{ date('Y') }}</h5>
                                   <p class="mB-0">You have donated so far</p>
                               </div>
                               <div class="peer">
                                   <h3 class="text-right"> USD {{ $totalDonationAmount }}</h3></div>
                           </div>
                       </div>
